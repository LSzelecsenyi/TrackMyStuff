...
object ActualSetLogic {
    ...
    private fun exerciseSnapshot(
        measurement: MeasurementType,
        resistance: ResistanceBasis
    ): hu.laca.weighttracker.domain.exercise.Exercise {
        return hu.laca.weighttracker.domain.exercise.Exercise(
            id = 0L,
            name = "",
            normalizedName = "",
            category = hu.laca.weighttracker.domain.exercise.ExerciseCategory.STRENGTH,
            movementPattern = hu.laca.weighttracker.domain.exercise.MovementPattern.OTHER,
            ...
            primaryMuscle = hu.laca.weighttracker.domain.exercise.MuscleGroup.FULL_BODY,
