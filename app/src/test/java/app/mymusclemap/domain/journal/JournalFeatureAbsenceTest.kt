...
class JournalFeatureAbsenceTest {
    ...
    fun sourceDoesNotIntroduceRirRpeHeatmapOrStatisticsUi() {
        val journalRoots = listOf(
            File("src/main/java/app/mymusclemap/ui/history"),
            File("src/main/java/app/mymusclemap/domain/journal"),
            File("app/src/main/java/app/mymusclemap/ui/history"),
            File("app/src/main/java/app/mymusclemap/domain/journal")
        )
